...
<!-- ::::::::    OTHER2 FUNCTION	:::::::::::::::::::::::::::::::::::::::: -->
					...
					<div style="margin:5px; float:left; height:120px; width:120px; padding:9px 5px; background-repeat: no-repeat; background-position: 0 0px; background-image: url(img/<?php echo $image;?>); border-color: #333333; border-style: solid; border-width: 1px;">
		      			...
		      			<div style="background-color:black; padding:0px 4px;"><p><small><?php //echo $id.'-';?><?php echo $city;?></small></p>
		      			</div> 
		      			
		      			<div class="lead" style="background-color:white; padding:2px 4px; font-size:1.2em; margin-top:-7px; line-height: 13px; "><?php echo $name;?>
		      			</div> 
