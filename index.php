...
$query="
select state, COUNT(exist) as mystate FROM $tiempo WHERE exist=$filtro;
";
$result = mysql_query($query);
...
switch($area){
	...
	default:$titarea="Showing All";
			$titarea2="(East, West & Caribbean in alphabetical order)";		
}
...
<!-- SLIDE FINISH HERE, LIST START	 -->
	...
	<span class="lead" style="font-size:2.6em; color:#333;"> <img src="img/icotuto.png"> <?php echo $titarea; ?></span>
	<span class="lead" style="font-size:2.6em; color:#999;">TeamPlayers</span>
	<br/>
	<span style="color:#777; font-size:1em;"> &nbsp; &nbsp; &nbsp;<?php echo $titarea2; ?></span>
				...
				<span style="float:right;">
				    ...
				    <a class="btn" href="index.php?area=west"><img src="img/icoeast.png"> West</a>
				    <a class="btn" href="index.php?area=east"><img src="img/icowest.png"> East</a>
	...
	<table class="table table-condensed">
					...
					<?php if($currentcity!=$lastcity){?>
					
					<tr>
					
						
						<td colspan="6">
							<div class="statebox" style="background-color:#FFF; font-size:1.5em;"><?php echo $row['state']; ?></div>
						</td>
...
<!-- Column 2 -->						
					...
					?>
						...
						<span style="font-size:1.5em; color:green;"  class="lead"><?php echo $capitalized ?></span> 
	
						
					<?php }else{ ?>
					
					<span style="font-size:1.5em;"  class="lead"><?php echo $capitalized ?></span> 
...
-->
						...
						<span style="color:#ccc; font-size:0.5em;"><?php echo $row['id']; ?></span>

						<a class="btn btn-primary btn-warning btn-mini" href="det.php?id=<?php echo $row['id'] ?>"><i class="icon-plus"></i>Info</a>
	...
	<div class="span4"> 
				...
				<span class="lead" style="font-size:3.3em; line-height: 29px;">
					Welcome to <br/>Team Players<br/> 
					<span style="color:gray;">Our best deals</span>
				...
				<br/><br/><br/>
				<p>
				TeamPlayers is a select collection of our greatest partners, carefully chosen for their OUTSTANDING value.  If you are looking for our most Appealing Rates, Ample Availability, Unique Add-Ons and/or Exclusive Offers, you found the right place in TeamPlayers!
				</p>	
				<br/>
	...
	<br/><br/><br/>
		...
		<span class="lead" style="font-size:2.6em; color:gray;"> <img src="img/icotuto.png"> Best Sellers</span><br/><br/>
		
		<?php function box1($id){ ?>
		
		<div style="margin:2px; float:right;"><img src="img/slides/274_b.jpg" width="144px"/></div>
		...
		<span class="lead" style="font-size:2.6em; color:gray;"> <img src="img/icotuto.png"> Recently Added</span><br/><br/>
