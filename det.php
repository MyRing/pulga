...
?>
	...
	<script>  $("a").tooltip(); // this will trigger a tooltip on all <a> elements 
	</script>
...
<!-- ::::::::::::::::::::::ROW 2:::::::::::::::::::::: -->
      ...
      <div class="row">   
			...
			if($zip ==1){
			 ...
			 ?>	
      		        <a class="btn btn-primary" href="zip/<?php echo $row['id']; ?>.zip"><i class="icon-arrow-down"></i><i class="icon-picture"></i> Download Photos</a>
